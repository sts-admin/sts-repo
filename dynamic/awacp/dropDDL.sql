...
ALTER TABLE INVOICE DROP FOREIGN KEY FK_INVOICE_ITEM1_ID;
ALTER TABLE INVOICE DROP FOREIGN KEY FK_INVOICE_JOBORDER_ID;
ALTER TABLE INVOICE DROP FOREIGN KEY FK_INVOICE_TAXRATE_ID;
ALTER TABLE INVOICE DROP FOREIGN KEY FK_INVOICE_ITEM2_ID;
ALTER TABLE INVOICE DROP FOREIGN KEY FK_INVOICE_ITEM3_ID;
