...
public class QuotePdfGenerator {
	...
	private void addQuoteInformation() throws Exception {
		...
		cell = new PdfPCell(
				new Phrase(worksheet.getTakeoff().getJobName(), FontFactory.getFont(FontFactory.HELVETICA, 8)));
		cell.setColspan(3);
		cell.setBorder(Rectangle.NO_BORDER);
		table.addCell(cell);
		...
		cell = new PdfPCell(
				new Phrase(worksheet.getTakeoff().getJobAddress(), FontFactory.getFont(FontFactory.HELVETICA, 8)));
		cell.setColspan(3);
		cell.setBorder(Rectangle.NO_BORDER);
		table.addCell(cell);
		...
		cell = new PdfPCell(new Phrase("" + worksheet.getTakeoff().getDateCreated().getTime(),
				FontFactory.getFont(FontFactory.HELVETICA, 8)));
		cell.setBorder(Rectangle.NO_BORDER);
		table.addCell(cell);

		cell = new PdfPCell(
				new Phrase(worksheet.getTakeoff().getQuoteId(), FontFactory.getFont(FontFactory.HELVETICA, 8)));
		cell.setBorder(Rectangle.NO_BORDER);
		table.addCell(cell);

		cell = new PdfPCell(new Phrase("" + worksheet.getTakeoff().getQuoteDate().getTime(),
				FontFactory.getFont(FontFactory.HELVETICA, 8)));
		cell.setBorder(Rectangle.NO_BORDER);
		table.addCell(cell);

		cell = new PdfPCell(
				new Phrase("" + worksheet.getTakeoff().getUserCode(), FontFactory.getFont(FontFactory.HELVETICA, 8)));
		cell.setBorder(Rectangle.NO_BORDER);
		table.addCell(cell);
		...
		cell = new PdfPCell(new Phrase(
				"" + (worksheet.getTakeoff().getEngineerName() != null ? worksheet.getTakeoff().getEngineerName() : ""),
				FontFactory.getFont(FontFactory.HELVETICA, 8)));
		cell.setColspan(2);
		cell.setBorder(Rectangle.NO_BORDER);
		table.addCell(cell);
		...
		cell = new PdfPCell(new Phrase(
				"" + (worksheet.getTakeoff().getArchitectureName() != null
						? worksheet.getTakeoff().getArchitectureName() : ""),
				FontFactory.getFont(FontFactory.HELVETICA, 8)));
		cell.setColspan(2);
		cell.setBorder(Rectangle.NO_BORDER);
		table.addCell(cell);
	...
	private void addProductInformation() throws Exception {
		...
		for (WsManufacturerInfo wsManufacturerInfo : worksheet.getManufacturerItems()) {
			cell = new PdfPCell(new Phrase(wsManufacturerInfo.getManufacturer().getProductName(),
			...
			for (WsProductInfo pInfo : wsManufacturerInfo.getProductItems()) {
				cell = new PdfPCell(
						new Phrase("" + pInfo.getQuantity(), FontFactory.getFont(FontFactory.HELVETICA, 8)));
				cell.setBorder(Rectangle.NO_BORDER);
				table.addCell(cell);

				cell = new PdfPCell(new Phrase("" + pInfo.getProduct().getProductName(),
						FontFactory.getFont(FontFactory.HELVETICA, 8)));
				cell.setColspan(3);
				cell.setBorder(Rectangle.NO_BORDER);
				table.addCell(cell);
			...
			if (wsManufacturerInfo.getPdnis() != null) {
				cell = new PdfPCell(new Phrase("PDNI: Price Does Not Include",
						FontFactory.getFont(FontFactory.HELVETICA, 8, Font.BOLD)));
				cell.setColspan(4);
				cell.setBorder(Rectangle.NO_BORDER);
				cell.setGrayFill(GRAY_FILL);
				...
				for (Pdni pdni : wsManufacturerInfo.getPdnis()) {
					...
					cell = new PdfPCell(
							new Phrase("" + pdni.getPdniName(), FontFactory.getFont(FontFactory.HELVETICA, 8)));
					cell.setColspan(3);
					cell.setBorder(Rectangle.NO_BORDER);
					table.addCell(cell);
				}
	...
	private void addFooter() throws Exception {
		...
		cell = new PdfPCell(
				new Phrase("ALBERT WEISS AIR CONDITIONING PRODUCTS INC.. Copyright 2013. All rights reserved.",
						FontFactory.getFont(FontFactory.HELVETICA, 8)));
		cell.setColspan(4);
		cell.setHorizontalAlignment(Element.ALIGN_CENTER);
		cell.setBorder(Rectangle.NO_BORDER);
