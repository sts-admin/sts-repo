...
@NamedQueries({
		...
		@NamedQuery(name = "File.findAllBySourceMatchAndId", query = "SELECT file FROM File file WHERE file.archived = false AND LOWER(file.fileSource) LIKE :keyword AND file.fileSourceId =:fileSourceId ORDER BY file.id ASC"),
