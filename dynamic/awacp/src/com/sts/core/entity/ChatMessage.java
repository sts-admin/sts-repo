...
@NamedQueries({
		...
		@NamedQuery(name = "ChatMessage.listMyConversationsWith", query = "SELECT cm FROM ChatMessage cm WHERE cm.archived = 'false' AND ((cm.sourceUserId =:myUserId AND cm.targetUserId =:otherUserId) OR (cm.sourceUserId =:otherUserId AND cm.targetUserId =:myUserId)) ORDER BY cm.dateCreated DESC"),
