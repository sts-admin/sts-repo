...
public class AwacpMailTemplate {
	public static final StringBuffer PREMIUM_ORDER_EMAIL = new StringBuffer(""
			+"<table border='0' style='width:100%%;font-family:Verdana,Geneva,sans-serif'>"
				+"<tbody>"
					+"<tr>"
				     	+"<td colspan='3' align='center' style='background:#EEE'><img src='%s' width='100%%' height='50' /></td>"
				    +"</tr>"
				    +"<tr>"
				    	+"<td style='background:#EEE; width:20%%;font-size:12px' align='left'><b>PH. #</b> <br>%s</td>"
				        +"<td style='background:#EEE; width:53%%;font-size:13px' align='center'>%s</td>"
				        +"<td style='background:#EEE; width:27%%;font-size:12px' align='right'><b>Fax #</b><br>%s</td>"
				    +"</tr>"
				    +"<tr>"
			    		+"<td colspan='3' style='background:#EEE; width:100%%;' align='left'>"
			    			+"<table border='0' style='width:100%%;'>"
				    			+"<tbody>"
				    				+"<tr>"
				    					+"<td align='left' style='background:#EEE; width:50%%;'><span style='font-size:12px;'>Website: %s</span></td>"
				    					+"<td style='background:#EEE; width:50%%;' align='right'><span style='font-size:12px;'>Email: %s</span></td>"
				    				+"</tr>"
				    			+"</tbody>"
				    		+"</table>"
				    	+"</td>"			    				
				    	...
				    	+"<td colspan='3' valign='top'>"
					    	+"<table border='0' cellpadding='0' cellspacing='0' width='100%%' style='font-size:13px;'>"
					    		+"<tbody>"
					    			...
					    			+"<td></td>"
					                +"<td colspan='6'><center>"
					                    +"<span style='color:#ff0000; font-size:xx-large;font-weight: bold;'>%s PREMIUM ORDER</span> <br>"					                    
					                  +"</center></td>"
					              +"</tr>"
					              +"<tr>"
					                  +"<td colspan='7'>&nbsp;</td>"
					              ...
					              +"<tr>"
					              	+"<td width='5%%'>&nbsp;</td>"
					              	+"<td width='18%%' align='left' valign='top'><strong>JOB ID</strong></td>"
					                +"<td width='1%%'>:</td>"
					                +" <td width='33%%' align='left' valign='top'>%s</td>"
					                +"<td width='12%%' align='left' valign='top'><strong>ORDER DATE</strong></td>"
					                +"<td width='1%%'>:</td>"
					                +"<td width='30%%' align='left' valign='top'>%s</td>"
					              +"</tr>"   
					              +"<tr>"
					              	+"<td>&nbsp;</td>"
					                +"<td align='left' valign='top'><strong><span style='font-size:18px;'>WEISS PO:</span></strong></td>"
					                +"<td>:</td>"
					                +"<td align='left' valign='top' colspan='4'><span style='font-size:18px;'>%s</span></td>"
					              +"</tr>"
					              +"<tr>"
					                +"<td></td>"
					                +"<td align='left' valign='top'><strong>CUSTOMER NAME</strong></td>"
					                +"<td>:</td>"
					                +"<td align='left' valign='top' colspan='4'>%s</td>"
					              +"</tr>"
					              +"<tr>"
					              +"<td>&nbsp;</td>"
					                +"<td align='left' valign='top'><strong>SHIP TO, C/O </strong></td>"
					                +"<td>:</td>"
					                +"<td align='left' valign='top' colspan='4'>%s</td>"
					              +"</tr>"
					              +"<tr>"
					                +"<td></td>"
					               +"<td align='left' valign='top'><strong>ATTN :</strong></td>"
					                +"<td>:</td>"
					                +"<td align='left' valign='top' colspan='4'>%s</td>"
					              +"</tr>"
					              +"<tr>"
					                +"<td>&nbsp;</td>"
					                +"<td align='left' valign='top'><strong>JOB NAME</strong></td>"
					                +"<td>:</td>"
					                +"<td align='left' valign='top' colspan='4'>%s</td>"
					              +"</tr>"
					              +"<tr>"
					                +"<td></td>"
					                +"<td align='left' valign='top'><strong>JOB ADDRESS</strong></td>"
					                +"<td>:</td>"
					                +"<td align='left' valign='top' colspan='4'>%s</td>"
					              +"</tr>"
					              +"<tr>"
					              +"<td></td>"
					                +"<td align='left' valign='top'><strong>USERCODE</strong></td>"
					                +"<td>:</td>"
					                +"<td align='left' valign='top' colspan='4'>%s</td>"
					              +"</tr>"
					              +"<tr>"
					                +"<td>&nbsp;</td>"
					                +"<td align='left' valign='top'><strong>SALESMAN</strong></td>"
					                +"<td>:</td>"
					                +"<td align='left' valign='top'>%s</td>"
					                +"<td align='left' valign='top'><strong>SHIP DATE</strong></td>"
					                +"<td>:</td>"
					                +"<td align='left' valign='top'>%s</td>"
					              +"</tr>"
					              +"<tr>"
					              ...
					              +"<tr>"
					               +" <td></td>"
					               +" <td colspan='6'>"
					               		+ "<table width='90%%' border='1' style='font-size:12px;'>"
						                 +"<tbody>"	
							                 +"<tr bgcolor='#DADADA'>"
								                 +"<th width='17%%' scope='row'>Quantity</th>"
							                      +"<th width='17%%' scope='row'>Size</th>"
							                      +"<th width='66%%' scope='row'>Item</th>"
						                    +"</tr>"
							                +"%s"
						                 +"</tbody>"
					                 +"</table></td>"
					              ...
					              +"   <td colspan='7'><hr></td>"
					               ...
					               +"<tr>"
					                 +"<td></td>"
					                 +"<td colspan='6'><strong>SHIPPING DETAILS: </strong>%s </td>"
					               +"</tr>"
					               +"<tr>"
					                 +"<td colspan='7'>&nbsp;</td>"
					               +"</tr>"
					               +"<tr>"
					                 +"<td></td>"
					                 +"<td colspan='3'> For Pick-up orders only: <br>"
					                   +"Signature: ___________________________________________ <br>"
					                   +"Date: ____________________ </td>"
					                 +"<td colspan='3' valign='bottom'> Checked By: ____________________ </td>"
					               +"</tr>"
